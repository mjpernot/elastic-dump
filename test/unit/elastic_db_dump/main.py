...
"""Program:  main.py
    ...
    Description:  Unit testing of main in elastic_db_dump.py.
...
class UnitTest(unittest.TestCase):
    ...
    @mock.patch("elastic_db_dump.gen_libs.help_func")
    @mock.patch("elastic_db_dump.arg_parser.arg_parse2")
    def test_help_true(self, mock_arg, mock_help):
        ...
        Arguments:
            mock_arg -> Mock Ref:  elastic_db_dump.arg_parser.arg_parse2
            mock_help -> Mock Ref:  elastic_db_dump.gen_libs.help_func
    ...
    @mock.patch("elastic_db_dump.gen_libs.help_func")
    @mock.patch("elastic_db_dump.arg_parser")
    def test_help_false(self, mock_arg, mock_help):
        ...
        Arguments:
            mock_arg -> Mock Ref:  elastic_db_dump.arg_parser
            mock_help -> Mock Ref:  elastic_db_dump.gen_libs.help_func
    ...
    @mock.patch("elastic_db_dump.run_program")
    @mock.patch("elastic_db_dump.gen_libs.help_func")
    @mock.patch("elastic_db_dump.arg_parser")
    def test_dir_chk_crt_false(self, mock_arg, mock_help, mock_run):
        ...
        Arguments:
            mock_arg -> Mock Ref:  elastic_db_dump.arg_parser
            mock_help -> Mock Ref:  elastic_db_dump.gen_libs.help_func
            mock_run -> Mock Ref:  elastic_db_dump.run_program
